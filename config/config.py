...
EXPLAINABILITY_DECIMAL_PRECISION = int(os.getenv("EXPLAINABILITY_DECIMAL_PRECISION", "3"))
EXPLAINABILITY_NUM_ALTERNATIVE_MATCHES = int(os.getenv("EXPLAINABILITY_NUM_ALTERNATIVE_MATCHES", "3"))
CONFIDENCE_VERY_HIGH_THRESHOLD = float(os.getenv("CONFIDENCE_VERY_HIGH_THRESHOLD", "0.90"))
CONFIDENCE_HIGH_THRESHOLD = float(os.getenv("CONFIDENCE_HIGH_THRESHOLD", "0.75"))
CONFIDENCE_MODERATE_THRESHOLD = float(os.getenv("CONFIDENCE_MODERATE_THRESHOLD", "0.60"))
